...
- Alternatively, you can use a privacy service such as [**Incogni**](https://incogni.com/) or [**DeleteMe**](https://joindeleteme.com/) to help automate this process (both of these services charge start at $20 for one month and over $140 per year for their services. These services automatically send legal “Right to Erasure” requests to hundreds of data brokers on your behalf and, critically, keep monitoring to make sure they don’t re-add you later)
